...
First, copy the file .env.sample into a new file called ".env". Ensure that you're using the correct values in your local .env file, make sure that the URL of your app is included in the ALLOWED_DOMAINS.
